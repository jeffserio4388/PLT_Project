...
\section{interface}
The architecture of pipeline compiler consists of the following components, Scanner, Parser, Semantic checker, and the codegen as shown in the above diagrams. All of the fiels are included in the \\
